...
public interface IVendaService
{
    ...
    Task<List<VendaRealizadaDto>> FiltrarAsync(string comprado, string formaDePagamento, DateTime? dataFinal, DateTime? dataInicial);
    Task<string> AbaterValorAsync(int idVenda, VendaRealizadaDto atualizar);
