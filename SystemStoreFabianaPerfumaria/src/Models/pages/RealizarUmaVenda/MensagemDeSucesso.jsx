...
const MensagemDeSucesso = ({mensagemDeSucesso}) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Mensagem de sucesso</p>
          <p className="sub-text">{mensagemDeSucesso}</p>
        </div>
      </div>
    </StyledWrapper>
  );
...
export default MensagemDeSucesso;
